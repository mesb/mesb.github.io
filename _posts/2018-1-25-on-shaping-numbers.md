...
1.  [A brief rant on the numbers](#org702c6f5)
2.  [Displaying the sum of a sequence of numbers](#org31faac8)
3.  [Summing the first n odd numbers](#org858a33c)
4.  [Redisplaying the sum of the first n numbers](#org1d9283d)
    1.  [Display section for the desired display](#org1ee7a6a)
5.  [Conclusion](#orgbc637cd)
...
## Display section for the desired display
